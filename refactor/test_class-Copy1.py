...
import os
import fire
from data.util import get_topn,normalize
try:
...
class Config:
    #model_dir="checkpoints/iso_classifier_0716_13:53:02.pth"#模型保存路径
    model_dir="checkpoints/iso_classifier_0716_12:26:09.pth"#模型保存路径
    img_dir='/mnt/7/0704_train_48_64/'#数据父路径
    topN=100#每个病人选取多少个结点
    batch_size=8
    csv_file="train_0716_no.csv"#分类结果csv保存路径
    prob_threshould=0.0#概率阈值，只保存大于此概率的结点
    limit = 1000 # 最多测试多少个文件
    cls_model="iso_Classifier"
