...
class Config:
    ...
    batch_size=4
    img_dir='/home/x/data/datasets/tianchi/test2/'#待测试图像路径
    save_dir='/mnt/7/0709_test_0_23/'#分割结果保存路径
    model_dir="checkpoints/seg_0527_05:10:49.pth"#预加载模型路径
    prob_threshould=0.4#二值化概率阈值
...
def main(**kwargs):
    ...
    print done
    count=0
    for file_name in tqdm(all_test):
